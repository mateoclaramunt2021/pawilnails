export default function Hero() {
  return (
    <section id="inicio" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-b from-rosa-950/90 via-rosa-900/70 to-rosa-800/50" />
        <div className="absolute inset-0 bg-gradient-to-t from-[#FFFBFC] via-transparent to-transparent opacity-90" />
